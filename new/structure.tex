...
% E-reader optimized settings
\setstocksize{15.2cm}{11.4cm}    % Match 6-inch e-reader screen
\settrimmedsize{\stockheight}{\stockwidth}{*}
\setlrmarginsandblock{24pt}{24pt}{*}    % Wider symmetric margins
\setulmarginsandblock{32pt}{32pt}{*}    % Symmetric top/bottom
\setheadfoot{14pt}{12pt}
\setheaderspaces{*}{10pt}{*}

% US Trade Size
%\setstocksize{9in}{6in}    % 9" × 6"
%\settrimmedsize{\stockheight}{\stockwidth}{*}
%\setlrmarginsandblock{1in}{1in}{*}     % 1 inch margins
%\setulmarginsandblock{1in}{1in}{*}     % Equal margins all around
%\setheadfoot{14pt}{14pt}
%\setheaderspaces{*}{10pt}{*}


% 12mo Book Size
%\setstocksize{187mm}{127mm} % 12mo Paper size

% A5 Book Sizing
%\setstocksize{210mm}{148mm} % A5 Book Size
%\settrimmedsize{\stockheight}{\stockwidth}{*} % No trims
%\setlrmarginsandblock{20mm}{15mm}{*}  % Left/right margins (A5)
%\setulmarginsandblock{25mm}{20mm}{*}  % Top/bottom margins (A5)
%\setheadfoot{12pt}{14pt}     % Header/footer height (A5)
%\setheaderspaces{*}{4mm}{*}  % Header Space (A5)
